...
public class UserIntroFragment extends Fragment {
	...
	// [start]继承方法
	// LayoutInflater Layout文件转换为View
	@Override
	...
	private void setControl() {
		...
		txtEP.setText(getString(R.string.user_center_e_coin, mUserResponse
				.getInfo().getEoe_m()));
		txtEM.setText(getString(R.string.user_center_e_reputation,
				mUserResponse.getInfo().getEoe_p()));
