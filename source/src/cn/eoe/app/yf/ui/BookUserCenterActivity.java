...
import cn.eoe.app.R;
import cn.eoe.app.yf.biz.UserDao;
...
import cn.eoe.app.yf.view.UserCollectFragment;
import cn.eoe.app.yf.view.UserIntroFragment;
import cn.eoe.app.yf.view.UserLogOutFragment;

/*个人中心*/
public class BookUserCenterActivity extends BaseFragmentActivity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		share = getSharedPreferences(BookUserLoginUidActivity.SharedName,
	...
	public class TabPageAdapter extends FragmentPagerAdapter {
		...
		public TabPageAdapter(BookUserCenterActivity userCenterActivity) {
	...
	public class ContentAsyncTask extends AsyncTask<String, Void, UserResponse> {
		...
		protected UserResponse doInBackground(String... params) {
			// TODO Auto-generated method stub
			return mUserDao.mapperJson(
					share.getString(BookUserLoginUidActivity.UID, ""),
					share.getString(BookUserLoginUidActivity.PWD, ""));
...
//					UserLoginUidActivity.KEY, ""));
		...
		protected void onPostExecute(UserResponse result) {
			...
			// 若用户未注册，将只显示一个
			// 否则，显示三个tab：我的收藏，个人简介，退出功能
			if (result == null) {
				UserLogOutFragment fragment = new UserLogOutFragment(
						BookUserCenterActivity.this, true);
...
/*			mTabsAdapter
					.addTab(getString(R.string.user_center_my_Collect),
							new UserCollectFragment(result,
									BookUserCenterActivity.this));*/
			...
			mTabsAdapter.addTab(getString(R.string.user_center_exit),
					new UserLogOutFragment(BookUserCenterActivity.this, false));
		...
		public void onClick(View v) {
			...
			case R.id.imageview_user_title:
				new PopupWindowUtil(mViewPager).showActionWindow(v,
						BookUserCenterActivity.this, mTabsAdapter.tabs);
				break;
			}
		}
	}
