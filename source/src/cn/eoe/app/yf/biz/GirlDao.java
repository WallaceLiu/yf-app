...
/*女频*/
public class GirlDao extends BaseDao {
	...
	public GirlDao(Activity activity) {
		super(activity);
	}
	...
	public BooksResponseEntity mapperJson(boolean useCache) {
		...
		try {
			String result = RequestCacheUtil.getRequestContent(mActivity,
					Urls.YF_GIRL_URL, Constants.WebSourceType.Json,
			...
			/*
			 * File file = new File("sdcard/girl.json"); FileInputStream
